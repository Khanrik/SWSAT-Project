...
DATA_PATH = "backend/src/models/ground/"
...
def main():
    passes = load_passes(DATA_PATH + "input1_passes_medium.json")
    antenna_limits, min_spacing_minutes, max_downlink_budget, max_passes_per_day = load_policies(DATA_PATH + "input1_policy_medium.json")
